...
namespace App.Persistence.Migrations
{
    ...
    [Migration("20230930214118_101_initial")]
    partial class _101_initial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Core.Models.CategoryPost", b =>
                {
            ...
            modelBuilder.Entity("App.Core.Models.Page", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Context = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce elementum, enim et dapibus efficitur, augue augue blandit ex, et scelerisque orci felis quis massa. Donec viverra risus augue, ac auctor nisl ultrices id.",
                            Title = "About"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Core.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            Context = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vulputate id nisi tristique ullamcorper. Vestibulum aliquam ipsum ac diam lacinia, vitae posuere urna efficitur. Cras tempus quam ut condimentum iaculis. Donec euismod enim et tristique feugiat. Suspendisse non malesuada eros. Nulla id enim sit amet orci fringilla interdum. Etiam ultricies pharetra elit, eget vulputate odio. Fusce facilisis in lacus id lacinia. In ex lacus, convallis nec sapien non, placerat consectetur ipsum. Quisque cursus ligula id ullamcorper sagittis. Vivamus ultricies mollis augue. Nunc vel erat vitae purus vestibulum egestas.",
                            Date = new DateTime(2010, 7, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Consectetur adipiscing.",
                            UserId = 3
                        });
                });

            modelBuilder.Entity("App.Core.Models.PostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Core.Models.PostImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Core.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Email = "cengizkurtoglu@gmail.com",
                            Name = "Cengiz",
                            Password = "cengiz123",
                            Surname = "Kurtoğlu"
                        },
            ...
            modelBuilder.Entity("App.Core.Models.CategoryPost", b =>
                {
                    ...
                    b.HasOne("App.Core.Models.Post", "Post")
                        .WithMany("CategoryPosts")
